...
# with open('cleanData_41-KhanhHoa_2019.csv', mode="w", encoding='utf8', newline='') as fileCSV:
...
for sbd in range(start, end):
	...
	url = "https://vietnamnet.vn/vn/giao-duc/tra-cuu-diem-thi-thpt/?y=2019&sbd=" + str(sbd)
	...
	# writing  to cln_Data variable for writing to .csv file
	# sbd_str = "0" + str(sbd)
	cln_Data = [str(sbd)]
	...
	with open('cleanData_41-KhanhHoa_2019.csv', mode='a', encoding='utf8', newline='') as fileCSV:
		writer = csv.writer(fileCSV)
