...
with open("cleanData_01-HaNoi.csv", encoding="utf8", mode="w", newline='') as fileCSV:
	header = ["SBD", "Toán", "Ngữ Văn", "Ngoại Ngữ", "Vật Lý", "Hóa Học", "Sinh Học", "Lịch Sử", "Địa Lý", "GDCD"]
	writer = csv.writer(fileCSV)
	writer.writerow(header)

file = open("rawData_01-HaNoi_2020.txt", "r")
...
for data in datas:
	...
	with open("cleanData_01-HaNoi.csv", "a", encoding='utf8', newline='') as fileCSV:
		writer = csv.writer(fileCSV)
